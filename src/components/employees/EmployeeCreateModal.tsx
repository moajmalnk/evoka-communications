...
import { X, User, Mail, Phone, MapPin, Calendar, IndianRupee, Building, UserCheck, Plus } from 'lucide-react';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: `${formData.firstName} ${formData.lastName} has been successfully added to the team.`,
      });
