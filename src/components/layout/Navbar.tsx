...
export function Navbar() {
  ...
  return (
    <header className={`fixed top-0 right-0 z-40 flex h-16 items-center justify-between border-b border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 px-3 sm:px-4 transition-all duration-300 ease-in-out left-0 ${isDesktopSidebarOpen ? 'lg:left-64' : 'lg:left-0'}`}>
      ...
      <div className="flex items-center gap-2 sm:gap-4">
        ...
        >
          ...
          <Badge 
            variant="destructive" 
            className="absolute -top-0.5 -right-0.5 h-4 w-4 p-0 text-xs flex items-center justify-center"
          >
            6
          </Badge>
        </Button>
