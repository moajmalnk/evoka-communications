...
export const mockWorkSubmissions: WorkSubmission[] = [
  ...
  // Sub Task Work Submissions
  {
    id: 'WS-006',
    taskId: 'T-007',
    taskTitle: 'Create Navigation Component',
    projectId: 'P-001',
    projectName: 'Website Redesign',
    employeeId: 'emp-7',
    employeeName: 'Alex Turner',
    coordinatorId: 'coord-1',
    coordinatorName: 'Alice Johnson',
    title: 'Navigation Component Completed',
    description: 'Successfully developed the main navigation component with responsive design, accessibility features, and smooth animations. Component includes mobile hamburger menu and proper keyboard navigation.',
    timeSpent: 6.5,
    attachments: [
      {
        id: 'att-10',
        name: 'navigation-component.jsx',
        url: '/attachments/navigation-component.jsx',
        size: 8192,
        type: 'text/javascript',
        uploadedAt: '2024-01-23T11:30:00Z',
      },
      {
        id: 'att-11',
        name: 'navigation-styles.css',
        url: '/attachments/navigation-styles.css',
        size: 4096,
        type: 'text/css',
        uploadedAt: '2024-01-23T11:30:00Z',
      },
    ],
    submissionDate: '2024-01-23T11:30:00Z',
    status: 'approved',
    reviewDate: '2024-01-23T14:15:00Z',
    reviewedBy: 'coord-1',
    reviewerRole: 'project_coordinator',
    feedback: 'Excellent work on the navigation component. Clean code, proper accessibility implementation, and responsive design. Ready for integration.',
  ...
  },
  {
    ...
    coordinatorId: 'coord-3',
    coordinatorName: 'Carol Davis',
    title: 'Brand Color Palette Finalized',
    description: 'Created a comprehensive color palette with primary, secondary, and accent colors. Includes color variations for different use cases and proper contrast ratios for accessibility compliance.',
    timeSpent: 4.0,
    attachments: [
      {
        id: 'att-12',
        name: 'color-palette.pdf',
        url: '/attachments/color-palette.pdf',
        size: 2097152,
        type: 'application/pdf',
      ...
      {
        id: 'att-13',
        name: 'color-usage-guidelines.md',
        url: '/attachments/color-usage-guidelines.md',
        size: 6144,
        type: 'text/markdown',
        uploadedAt: '2024-01-12T14:00:00Z',
      },
    ],
    submissionDate: '2024-01-12T14:00:00Z',
    status: 'approved',
    reviewDate: '2024-01-12T16:30:00Z',
    reviewedBy: 'coord-3',
    reviewerRole: 'project_coordinator',
    feedback: 'Perfect color palette that aligns with our brand vision. The accessibility considerations are well thought out. Approved for implementation.',
  ...
  },
  {
    ...
    coordinatorId: 'coord-1',
    coordinatorName: 'Alice Johnson',
    title: 'Homepage Wireframes Updated',
    description: 'Updated homepage wireframes based on client feedback. Improved user flow, added new sections, and refined the overall layout structure.',
    timeSpent: 5.5,
    attachments: [
      {
        id: 'att-14',
        name: 'updated-wireframes-v2.pdf',
        url: '/attachments/updated-wireframes-v2.pdf',
        size: 3145728,
        type: 'application/pdf',
    ...
    status: 'needs_revision',
    reviewDate: '2024-01-22T11:45:00Z',
    reviewedBy: 'coord-1',
    reviewerRole: 'project_coordinator',
    feedback: 'Good progress on the wireframes. Please adjust the hero section layout and consider adding more visual hierarchy in the content sections.',
  ...
  },
  {
    ...
    description: 'Optimized the database schema for better performance. Added proper indexing, normalized tables, and implemented data validation rules.',
    timeSpent: 8.0,
    attachments: [
      {
        id: 'att-15',
        name: 'optimized-schema.sql',
        url: '/attachments/optimized-schema.sql',
        size: 1536000,
        type: 'application/sql',
      ...
      },
      {
        ...
        url: '/attachments/performance-report.pdf',
        size: 1048576,
        type: 'application/pdf',
        uploadedAt: '2024-01-24T13:20:00Z',
      },
    ],
    submissionDate: '2024-01-24T13:20:00Z',
    status: 'pending_review',
  ...
  },
  {
    id: 'WS-010',
    taskId: 'T-009',
    taskTitle: 'Create Form Components',
    projectId: 'P-001',
    projectName: 'Website Redesign',
    employeeId: 'emp-7',
    employeeName: 'Alex Turner',
    coordinatorId: 'coord-1',
    coordinatorName: 'Alice Johnson',
    title: 'Form Components Implementation',
    description: 'Implemented comprehensive form components with validation, error handling, and accessibility features. Components include text inputs, select dropdowns, checkboxes, and radio buttons.',
    timeSpent: 7.5,
    attachments: [
      {
        id: 'att-17',
        name: 'form-components.jsx',
        url: '/attachments/form-components.jsx',
        size: 12288,
        type: 'text/javascript',
        uploadedAt: '2024-01-27T16:45:00Z',
      },
      {
        id: 'att-18',
        name: 'form-validation-rules.js',
        url: '/attachments/form-validation-rules.js',
        size: 6144,
        type: 'text/javascript',
        uploadedAt: '2024-01-27T16:45:00Z',
      },
    ],
    submissionDate: '2024-01-27T16:45:00Z',
    status: 'approved',
    reviewDate: '2024-01-28T09:30:00Z',
    reviewedBy: 'coord-1',
    reviewerRole: 'project_coordinator',
    feedback: 'Outstanding work on the form components. Excellent validation implementation and accessibility compliance. Ready for production use.',
  ...
  },
  {
    ...
    description: 'Completed comprehensive API integration testing with detailed test cases covering all endpoints. Identified and documented 3 minor issues which have been reported to the backend team.',
    timeSpent: 9.0,
    attachments: [
      {
        id: 'att-19',
        name: 'api-test-report.pdf',
        url: '/attachments/api-test-report.pdf',
        size: 1572864,
        type: 'application/pdf',
        uploadedAt: '2024-01-30T14:20:00Z',
      },
      {
        id: 'att-20',
        name: 'test-cases.json',
        url: '/attachments/test-cases.json',
        size: 8192,
        type: 'application/json',
        uploadedAt: '2024-01-30T14:20:00Z',
      },
    ],
    submissionDate: '2024-01-30T14:20:00Z',
    status: 'pending_review',
